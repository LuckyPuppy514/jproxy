    ...
    var miniTab = {
        ...
        openTabRignMenu: function (tabId, left) {
            ...
            var menuHtml = '<div class="layui-unselect layui-form-select layui-form-selected layuimini-tab-mousedown layui-show" data-tab-id="' + tabId + '" style="left: ' + left + 'px!important">\n' +
                '<dl>\n' +
                '<dd><a href="javascript:;" layuimini-tab-menu-close="current">' + localStorage.CLOSE_CURRENT + '</a></dd>\n' +
                '<dd><a href="javascript:;" layuimini-tab-menu-close="other">' + localStorage.CLOSE_OTHER + '</a></dd>\n' +
                '<dd><a href="javascript:;" layuimini-tab-menu-close="all">' + localStorage.CLOSE_ALL + '</a></dd>\n' +
                '</dl>\n' +
                '</div>';
